...
export async function rememberConversation(
  ...
  // HAVEN: Disabled background reflection and shared context LLM calls to prevent burning tokens.
  // Context remains stored and retrievable specifically for the individual character when they interact with the child.
...
// HAVEN: Query to get all agents in a world (for shared memory)
